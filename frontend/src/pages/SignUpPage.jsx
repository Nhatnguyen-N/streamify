...
const SignUpPage = () => {
  ...
  return (
    ...
    >
      <div
        className=" bg-base-100 border border-primary/25 flex flex-col lg:flex-row w-full
      max-w-5xl mx-auto rounded-xl shadow-lg overflow-hidden"
      >
